...
### *_p5b.sh       Butterfly job. "NUMPERARRAYITEM" tasks from the file /chrysalis/butterfly_commands.adj are run for each job 
...
TRINITYPATH="/home/pap056/software/trinityrnaseq/"
...
MODTRINITY="
 $NEWPATH;
 export TRINITYPATH="/home/pap056/software/trinityrnaseq/";
 $MODTRINITY
"
##################################################################################################################################
##################################################################################################################################
