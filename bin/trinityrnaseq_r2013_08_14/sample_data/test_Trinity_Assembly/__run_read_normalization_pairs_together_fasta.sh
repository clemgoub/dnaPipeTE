...
../../util/normalize_by_kmer_coverage.pl --seqType fa --left reads.left.fa --right reads.right.fa --SS_lib_type RF --JM 1G --max_cov 2 --output normalized_reads_test --pairs_together
