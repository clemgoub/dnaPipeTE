...
#    Revision 1.13  2015/08/07 19:06:52  rhubley
...
#  $Name: open-4-0-6 $ macro will be blank and thus we use
#  this as the development version.
#
my $CVSTag = '$Name: open-4-0-6 $';
my $version;
if ( $CVSTag =~ /\$\s*Name:\s*open-(\S+)\s*\$/ ) {
  ...
  $version =
'development-$Id: getRepeatMaskerBatch.pl,v 1.13 2015/08/07 19:06:52 rhubley Exp $';
}
