...
$Trinity --seqType fa --JM 10G --single $2/renamed.input.fasta --CPU $3 --min_glue 0 --min_contig_length 100 --output $2/Trinity_run1
...
echo ''
$Trinity --seqType fa --JM 10G --single $2/reads_run2.fasta --CPU $3 --min_glue 0 --min_contig_length 100 --output $2
