	...
	def repeatmasker_run(self):
		...
		if not os.path.exists(self.output_folder+"/Annotation"):
			...
			with open(self.output_folder+"/Trinity.fasta.out", 'r') as trinity_handle:
				...
				prev_contig = ""
				with open(self.output_folder+"/Annotation/one_RM_hit_per_Trinity_contigs", 'w') as output and open(self.output_folder+"/Annotation/Best_RM_annot_80", 'w') as output_80_80 and open(self.output_folder+"/Annotation/Best_RM_annot_partial", 'w') as output_partial:
